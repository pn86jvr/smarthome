...
| language  | Language to be considered by the Weather Underground service. Optional, the default value is EN (English). |
...
| Current | iconUrl | String | Icon URL representing the weather current conditions | |
...
| forecastToday forecastTomorrow forecastDay2 ... forecastDay9 | iconUrl | String | Icon URL representing the weather forecast conditions | |
...
Thing weatherunderground:weather:CDG "Météo Paris CDG" [ apikey="XXXXXXXXXXXX", location="CDG", language="FR" ] {
    Channels:
        ...
        Type windSpeed : current#windGust [ SourceUnit="kmh" ]
        Type pressure : current#pressure [ SourceUnit="hPa" ]
        Type temperature : current#dewPoint [ SourceUnit="C" ]
        Type temperature : current#heatIndex [ SourceUnit="C" ]
        Type temperature : current#windChill [ SourceUnit="C" ]
        Type temperature : current#feelingTemperature [ SourceUnit="C" ]
        Type visibility : current#visibility [ SourceUnit="km" ]
        Type rain : current#precipitationDay [ SourceUnit="mm" ]
        Type rain : current#precipitationHour [ SourceUnit="mm" ]
        Type temperature : forecastToday#minTemperature [ SourceUnit="C" ]
        Type temperature : forecastToday#maxTemperature [ SourceUnit="C" ]
        Type rain : forecastToday#precipitationDay [ SourceUnit="mm" ]
        Type snow : forecastToday#snow [ SourceUnit="cm" ]
        Type windSpeed : forecastToday#maxWindSpeed [ SourceUnit="kmh" ]
        Type windSpeed : forecastToday#averageWindSpeed [ SourceUnit="kmh" ]
}
```
...
String IconUrl "Icon URL [%s]" {channel="weatherunderground:weather:CDG:current#iconUrl"}
...
String ForecastIconUrl "Forecast icon URL [%s]"  {channel="weatherunderground:weather:CDG:forecastToday#iconUrl"}
